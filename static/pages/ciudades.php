            ...
            <div class="row" style="padding-top:10px;">
                <div class="col-lg-12">
                   ...
                   <div class="col-md-4">
                     <div class="thumbnail">
                       <a href="#">
                         <img src="../images/concepcion.jpg" alt="Lights" style="width:100%;">
                         <div class="caption">
                           <p>Concepción</p>
                         </div>
                       </a>
                   ...
                   <div class="col-md-4">
                     <div class="thumbnail">
                       <a href="#">
                         <img src="../images/copiapo.jpg" alt="Nature" style="width:100%;height:222px;">
                         <div class="caption">
                           <p>Copiapo</p>
                         </div>
                       </a>
                   ...
                   <div class="col-md-4">
                     <div class="thumbnail">
                       <a href="#">
                         <img src="../images/serena.jpg" alt="Nature" style="width:100%;height:222px;">
                         <div class="caption">
                           <p>La Serena</p>
                         </div>
                       </a>
...
<div class="col-lg-12">
                <div class="col-md-4">
                     <div class="thumbnail">
                       <a href="santiago.php">
                         <img src="../images/santiago.jpg" alt="Lights" style="width:100%;">
                         <div class="caption">
                           <p>Santiago</p>
                         </div>
                       </a>
                   ...
                   <div class="col-md-4">
                     <div class="thumbnail">
                       <a href="#">
                         <img src="../images/temuco.jpg" alt="Nature" style="width:100%;height:222px;">
                         <div class="caption">
                           <p>Temuco</p>
                         </div>
                       </a>
                   ...
                   <div class="col-md-4">
                     <div class="thumbnail">
                       <a href="#">
                         <img src="../images/valdivia.jpg" alt="Nature" style="width:100%;height:222px;">
                         <div class="caption">
                           <p>Valdivia</p>
                         </div>
                       </a>
