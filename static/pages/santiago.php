...
<div id="myCarousel" class="carousel slide" data-ride="carousel" >
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="/cedeus/images/santiago.jpg" alt="Santiago1">
    </div>
    <div class="item">
      <img src="/cedeus/images/santiago3.jpg" alt="Santiago2">
    </div>
...
<div class="col-lg-12">
  ...
  <table class="table table-bordered">
    <thead>
      <tr style="font-size:18px;font-family: 'Open Sans Condensed Bold';color:#000000;" background="/cedeus/images/participacion.PNG">
  ...
  <table class="table table-bordered">
    <thead>
      <tr style="font-size:18px;font-family: 'Open Sans Condensed Bold';color:#ffffff;" background="/cedeus/images/hojas.jpg">
  ...
  <table class="table table-bordered">
    <thead>
      <tr style="font-size:18px;font-family: 'Open Sans Condensed Bold';color:#ffffff;" background="/cedeus/images/agua.jpg">
