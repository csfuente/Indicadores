...
def nosotros(request):
	ciudades = Ciudad.objects.all()
	return render_to_response('nosotros.html',{'ciudades':ciudades},context_instance=RequestContext(request))
...
def santiago(request):
	...
	#return index(request)
	return render_to_response('ciudad.html',context_instance=RequestContext(request))
...
def indicadores(request):
	...
	#else:
	#	return render_to_response('pages/indicadores.php',{'categorias':categorias},context_instance=RequestContext(request))
	return render_to_response('indicadores.html',context_instance=RequestContext(request))
...
def comparar_ciudades(request):
	...
	return render_to_response('comparador.html',context_instance=RequestContext(request))
