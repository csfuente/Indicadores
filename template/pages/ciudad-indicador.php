...
<div id="page-wrapper" style="margin:0;">
            ...
            <div class="row" style="padding-top:55px;">
                ...
                <div class="col-xs-12 col-md-8 col-lg-8">
                    ...
                    {% for dato in datos %}
                    <div class="col-xs-12 col-md-12 col-lg-12" style="text-align: -webkit-center;">
                        <p><div style="font-family: 'Open Sans';font-size:22px;color:#fffff;"><strong style="font-family: 'Open Sans Condensed Bold';font-size:24px;color:#000;">Valor: </strong> 
                            {% if dato.tipo_variable == 'caracter' %}
                            {{dato.var_char}} [unidad medida]
                            {% elif dato.tipo_variable == 'numero entero'%}
                            {{dato.var_int}} [unidad medida]
                            {% else %}
                            {{dato.var_float}} [unidad medida]
                            {% endif%}
